...
import 'package:tourism_app/modules/business_module/models/finished_booking.dart';
            ...
            children:[
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        fit: BoxFit.cover,
                        image: NetworkImage(finished.imageUrl)
                    )
                ),
              ...
              Expanded(
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      LargeText(text: finished.customerName,color: Colors.black,),
