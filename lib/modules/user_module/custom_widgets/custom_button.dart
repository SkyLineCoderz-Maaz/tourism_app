...
class _CustomButtonState extends State<CustomButton> {
  ...
  Widget build(BuildContext context) {
    if (widget.systemBrightness != null && brightness != MediaQuery.of(context).platformBrightness) {
    ...
    Color textColor = widget.textColor ?? (brightness == Brightness.light ? Colors.black : Colors.white);
